...
class EmailHandler
{
    public static function modeloEmail($title, $nome, $header, $body, $main, $btn_link, $btn_txt, $rodape, $system_link, $logo, $laboratorio, $width = null)
    {
    ...
    public static function enviarEmail($email_recebe, $name_recebe, $subject, $html, $host, $email, $name, $senha, $smtp)
    {
        ...
        $mail->Body       = $html;
        $mail->AddAddress($email_recebe, $name_recebe);
